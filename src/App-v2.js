...
function Search({ query, setQuery }) {
  return (
    <input
      ...
      value={query} // Show the current query in the input box
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  useEffect(
    function () {
      async function getMoviesDeatails() {
        setIsLoading(true);
        const res = await fetch(
